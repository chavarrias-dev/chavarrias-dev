...
export function NewClientForm({ errorMessage }: NewClientFormProps) {
  return (
    <div className="mx-auto w-full max-w-xl">
      <header className="mb-8">
        ...
        <p className="mt-1.5 text-sm text-slate-500">
          Completa los datos del contacto o empresa.
        </p>
      </header>
      ...
      <form action={saveClient} className="space-y-5">
        ...
        <div>
          <label htmlFor="rfc" className="mb-1.5 block text-sm font-medium text-slate-700">
            RFC
          </label>
          <input
            id="rfc"
